...
function Import-RequiredModule{
    ...
    process{
        ...
        $module = Import-Module $ModuleName -PassThru -ErrorAction SilentlyContinue -MinimumVersion:$semVer -Scope Global
        ...
        if ($null -eq $module) {
            ...
            $module = $installed | ForEach-Object {Import-Module -Name $_.Name -RequiredVersion ($_.Version.Split('-')[0]) -Force -PassThru -Scope Global}
        }

...
function Get-Mock_Project_700 {
    ...
    # Repository Info
    $content = Get-MockFileContentJson -fileName $project.repofile -AsHashtable
    $project.repository = $content.data.repository
    $project.repository.owner = $content.data.repository.owner.login

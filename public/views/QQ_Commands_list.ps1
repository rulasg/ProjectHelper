...
function Register-QQ_Commands{
    ...
    New-QQ_Function -Module $modulename -Name "Invoke-QQ_Update_U"           -Alias "u"  -Description "Update project item"                          -ScriptBlock { $i = g ; W "Stub_ShowProjectItem $i" ; $i | Update-ProjectItem ; g | Stub_ShowProjectItem }
    ...
    New-QQ_Function -Module $modulename -Name "Invoke-QQ_Show_V"             -Alias "v"  -Description "Show the current item in the console"         -ScriptBlock { $i = g ; W "Stub_ShowProjectItem $i" ; $i | Stub_ShowProjectItem }
    New-QQ_Function -Module $modulename -Name "Invoke-QQ_ShowDetails_D"      -Alias "d"  -Description "Show the details of the current item"          -ScriptBlock { $i = g ; W "Stub_ShowProjectItem $i -AllComments " ; $i | Stub_ShowProjectItem -AllComments }
    New-QQ_Function -Module $modulename -Name "Invoke-QQ_ShowMini_M"         -Alias "m"  -Description "Show a minimal view of the current item"      -ScriptBlock { $i = g ; W "Stub_ShowProjectItem $i -Minimal " ; $i | Stub_ShowProjectItem -Minimal }

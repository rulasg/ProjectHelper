...
function Invoke-FindProjectItem{
    [CmdletBinding()]
    param(
    ...
    $qlPath =  $public | Join-Path -ChildPath "graphql" -AdditionalChildPath "orgprojectwithfieldsAndItems_find.query"
...
} Export-ModuleMember -Function Invoke-FindProjectItem
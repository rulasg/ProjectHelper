function Test_GetProjetItems_SUCCESS{
    ...
    Assert-AreEqual -Presented $randomItem.projectId    -Expected $p.id
    Assert-AreEqual -Presented $randomItem.projectUrl   -Expected $p.url

    Assert-AreEqual -Presented $randomItem.id           -Expected $i.id
    Assert-AreEqual -Presented $randomItem.number       -Expected $i.number
    Assert-AreEqual -Presented $randomItem.contentId    -Expected $i.contentId
    Assert-AreEqual -Presented $randomItem.Title        -Expected $i.title
    Assert-AreEqual -Presented $randomItem.Body         -Expected $i.body
    Assert-AreEqual -Presented $randomItem.url          -Expected $i.url
    Assert-AreEqual -Presented $randomItem.Status       -Expected $i.status
    ...
    Assert-AreEqual -Presented $randomItem."field-text"   -Expected $i.fieldtext
    Assert-AreEqual -Presented $randomItem."field-number" -Expected "333"
    Assert-AreEqual -Presented $randomItem."field-singleselect" -Expected $i.fieldsingleselect.name
    ...
    Assert-AreEqual -Presented $randomItem.urlContent   -Expected $i.url
